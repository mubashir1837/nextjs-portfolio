...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Uswa Public School Yultar Skadu</li>
        <li>Uswa College Islamabad</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Bioinformatics certificate</li>
        <li>Stanford University Health and food Certificate</li>
      </ul>
    ),
  },
];
